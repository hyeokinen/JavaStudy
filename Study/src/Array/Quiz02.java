...
public class Quiz02 {
	...
	public static void main(String[] args) {
		...
		// 입력: 변경할 index와 값을 입력하세요 : 2 16 출력: 3 5 16 10 39 
...
//		}
		...
		//시급 기준이 아래와 같을때 7일 동안 일한 총 임금의 값을 출력하세요. 평일 8500, 주말 9500
		...
		int hap = weekday+weekend;
		System.out.println("일주일간 총 임금은 " + hap + "원 입니다.");
